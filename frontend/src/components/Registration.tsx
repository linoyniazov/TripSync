...
function Registration() {
  ...
  return (
    <div className="vstack gap-3 col-md-7 mx-auto">
      ...
      <input style={{display:"none"}} ref={fileInputeRef} type="file" onChange={imgSelected}></input>
      <div className="form-floating">
        <input ref={emailInputeRef} type="text" className="form-control" id="floatingInput" placeholder=""/>
        <label htmlFor="floatingInput">Email</label>
      </div>
      <div className="form-floating">
        <input ref={passwordInputeRef}
          type="password"
