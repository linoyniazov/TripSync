...
//     testUserId = registerResponse.body._id; // קבלת ה-ID של המשתמש החדש

//     // התחברות כדי לקבל `accessToken`
...
//         postId = postsAfterCreation.body[0]._id;
//     });
...
//         expect(updatedPostById.description).toBe("Updated Test Description");
//         expect(updatedPostById.photos).toEqual(["photo3.jpg", "photo4.jpg"]);
//         expect(updatedPostById.userId).toBe(testUserId); // אין לשנות את userId
//     });
